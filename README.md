...
[![Go Report Card](https://goreportcard.com/badge/github.com/alexa-whitney/makesite)](https://goreportcard.com/report/github.com/alexa-whitney/makesite)
...
- [x] Add any third party library to your project to enhance it's functionality. Some ideas you might consider include **_(CHOOSE ONLY ONE)_**:
    ...
    - [x] **_FILL IN THE BLANK_**: `I will use the Aurora library. The documentation is located at https://github.com/logrusorgru/aurora. My goal is to use it to make the CLI output colorful and fun.`
- [x] **Add, commit, and push to GitHub**.
